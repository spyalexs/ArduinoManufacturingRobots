...
TravelStraight::TravelStraight(BLECharacteristic* StatusC, BLECharacteristic* IssueC, MotionController* MC, int counts):Command(StatusC, IssueC, MC, "TravelStraight"){
