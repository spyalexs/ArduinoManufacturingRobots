...
StationContainer::StationContainer(mc::DCMotor* motor1, mc::DCMotor* motor2, mc::Encoder* encoder1, mc::Encoder* encoder2, uint8_t lineFollowerPinName, uint8_t intersectionPinName, uint8_t codePinName){
  m_motor1 = motor1;
  m_motor2 = motor2;
  m_encoder1 = encoder1;
  m_encoder2 = encoder2;
...
void StationContainer::setMotor1(int duty){
  this->m_motor1->setDuty(-duty);
}

void StationContainer::setMotor2(int duty){
...
int StationContainer::getEncoder1Counts(){
  return -this->m_encoder1->getRawCount();
}

int StationContainer::getEncoder2Counts(){
  return this->m_encoder2->getRawCount();
}

int StationContainer::getLineFollowerPinReading(){
  return analogRead(m_lineFollowerPin);
}

bool StationContainer::isOnIntersectionMarker(){
  return !digitalRead(m_intersectionPin);
}

bool StationContainer::isCodePin(){
...
void StationContainer::lineControl(double* Correction1, double* Correction2){
...
void StationContainer::velocityControl(double* Power1, double* Power2){
...
bool StationContainer::isEncoderClicked(){
...
void StationContainer::cycleEncoder(){
...
int StationContainer::getDisplayEncoderCounts(){
  return this->m_encoderCounts;
}

void StationContainer::resetDisplayEncoder(){
  this->m_encoderCounts = 0;
}

void StationContainer::cycleUltrasonic(){
...
double StationContainer::getDistance(){
...
void StationContainer::handleMenuSelection(){
...
void StationContainer::handleEncoderClick(){
